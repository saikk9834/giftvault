...
export default function SendSurpriseScreen() {
  ...
  const handleSend = async () => {
    ...
    if (!selectedFriend) {
      Alert.alert(
        "Select a Friend",
        "Please choose who to send the surprise to.",
      );
      return;
    }
    if (!giftContent.trim()) {
      ...
      >
        ...
        {friends.length === 0 ? (
          ...
          >
            ...
            >
              <Text style={[styles.noFriendsAction, { color: colors.primary }]}>
                Go to Friends →
              </Text>
            </Pressable>
          </View>
        ...
        {giftImageUri ? (
          <View style={styles.puzzleImageWrapper}>
            <Image
              ...
              style={styles.puzzleImagePreview}
              contentFit="cover"
            />
            <Pressable
              onPress={() => setGiftImageUri(null)}
              style={[
                styles.puzzleImageRemove,
          ...
          >
            ...
            <Text style={[styles.previewText, { color: colors.muted }]}>
              ...
              <Text style={{ color: colors.foreground, fontWeight: "700" }}>
                {selectedFriend.name ?? `User ${selectedFriend.id}`}
              </Text>{" "}
              on{" "}
              <Text style={{ color: colors.foreground, fontWeight: "700" }}>
